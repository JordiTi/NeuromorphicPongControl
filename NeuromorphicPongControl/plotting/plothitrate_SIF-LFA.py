...
resultfilenames = os.listdir("../data/errorfiles/errorfiles_SIF-LFA/data/")
...
for f in resultfilenames:
    ...
    if f.startswith("lr"):
        ...
        with open(f"../data/errorfiles/errorfiles_SIF-LFA/data/{f}", "r") as errorfile:
...
np.savetxt("../data/plottingdata/SIF-LFA.txt",np.array(sorted_by_col))
